...
The dB scale
<details>
| dB  | Power ratio     | Can be compared with | Measured by ear |
|-----|-----------------|-----------------------|-----------------|
| 140 | 100000000000000 | Gunshot               | Pain            |
| 130 | 10000000000000  | Jet engine            | Pain            |
| 120 | 1000000000000   | Car horn              | Pain            |
| 110 | 100000000000    | Airport               | Very noisy      |
| 100 | 10000000000     | Nightclub             | Very noisy      |
| 90  | 1000000000      | Piano                 | Loud            |
| 80  | 100000000       | Alarm clock           | Moderate        |
| 70  | 10000000        | Vacuum cleaner        | Moderate        |
| 60  | 1000000         | Normal conversation   | Quiet           |
| 50  | 100000          | Quiet office          | Quiet           |
| 40  | 10000           | Whisper               | Faint           |
</details>
...
The researches for the different formats like: `ACC, MP3, FLAC`  is put here in the details since the hardware mentioned earlier can only support MP3.
<details>
...
---
***Lossy*** <br>
Lossy compression mean the compressed file is **NOT** able to return to it's original state. Some data will be lost in the compression. That's why lossy compressed audio files contain lower quality audio. For example the AAC file format uses a algorithm that detects frequencies that a human shouldn't be able to hear and removes these. 
