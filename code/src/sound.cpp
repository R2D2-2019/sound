...
namespace r2d2::sound {
    sound_c::sound_c(base_comm_c &comm, r2d2::sound::rtttl_player_c &player)
        ...
        comm.listen_for_frames({r2d2::frame_type::RTTTL_STRING});
    }
    ...
    void sound_c::process() {
        while (comm.has_data()) {
            ...
            const auto data = frame.as_frame_type<frame_type::RTTTL_STRING>();

            hwlib::cout << data.rtttl_string << hwlib::flush;
